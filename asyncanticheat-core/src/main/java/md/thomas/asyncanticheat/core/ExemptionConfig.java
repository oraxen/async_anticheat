 ...
 * <li>AAC5: config.yml checks.move.*, automatic exemptions</li>
 * <li>Vulcan: settings.ignore-*, grace windows</li>
 * </ul>
 * 
 * <p>
 * Default values are chosen based on what all three agree on,
 * with grace periods based on Vulcan's battle-tested values.
 */
public final class ExemptionConfig {
    ...
    // AAC and NCP both exempt these - meaningless data
    ...
    // ============= FLIGHT EXEMPTIONS =============
    // AAC: checks.move.check_flying (default: false = exempt)
