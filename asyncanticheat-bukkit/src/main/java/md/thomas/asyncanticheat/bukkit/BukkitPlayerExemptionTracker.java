 ...
 * 
 * <p>
 * Based on combined analysis of NoCheatPlus, AAC5, and Vulcan.
 */
public final class BukkitPlayerExemptionTracker extends PlayerExemptionTracker implements Listener {
    ...
    public ExemptionReason getExemptionReason(@Nullable Player player) {
        ...
        if (state != null) {
            ...
            // Velocity grace (Vulcan: 50 ticks = 2.5 seconds)
            ...
            // Flight cooldown (Vulcan: 40 ticks = 2 seconds after stopping flight)
        ...
        // Dead check (AAC: iS.b, NCP: early return)
        if (config.isSkipDead() && player.isDead()) {
            return ExemptionReason.DEAD;
        }

        // Sleeping check (AAC: iS.i, NCP: early return)
        ...
        // Gamemode checks (AAC: iS.r/iS.l, NCP: shouldCheckSurvivalFly)
